export default function Nav() {
  return (
    <header className="flex items-center justify-between px-12 py-4 bg-white/80 shadow-xl backdrop-blur-md text-gray-800 sticky top-0 z-50 rounded-b-2xl">
      ...
      <nav className="flex items-center gap-8 font-semibold uppercase tracking-wide text-lg">
        ...
        <a
          href="#apply-form"
          className="bg-[#E31E24] text-white px-6 py-3 rounded-full font-semibold hover:bg-red-700 transition shadow-md"
        >
          Apply Now
        </a>
      </nav>
